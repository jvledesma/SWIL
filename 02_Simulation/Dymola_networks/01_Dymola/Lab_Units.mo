...
//Constants
  ...
  package Interfaces
    ...
    connector Port_a
      extends Lab_Units.Interfaces.Port;
    ...
    partial model PartialTwoPort_Heat
      extends Lab_Units.Interfaces.PartialTwoPort;
  ...
  package Components
    ...
    extends Modelica.Icons.SourcesPackage;
      ...
      model Source_pT
          extends Lab_Units.Icons.Boundary       annotation (Icon(
              coordinateVirtualWaterLab(Interfaces(             Port_bSystem(                                     preserveAspectRatio=false)))),
                                                                                                                                               Diagram(
              coordinateSystem(preserveAspectRatio=false)));

        //Parameters
        parameter SI.Pressure p=Lab_Units.p_ambient;
        parameter SI.Temperature T=Lab_Units.T_ambient;
      ...
      equation
        port_b.p = p;
        port_b.h_outflow = Lab_Units.Functions.h_T(T);
      ...
      model Sink_pT
        extends Lab_Units.Icons.Boundary
        annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
              coordinateSystem(preserveAspectRatio=false)));
        //Parameters
        parameter SI.Pressure p=Lab_Units.p_ambient;
      ...
      equation
          port_a.p = p;
        port_a.h_outflow = Lab_Units.Functions.h_T(T);
    ...
    package Pipes
      ...
      equation
        ...
        f = Lab_Units.Components.Pipes.BaseClasses.WallFriction(
                diameter,
                V_flow,
                T,
                roughness);
    ...
    extends Modelica.Icons.VariantsPackage;
      ...
      model Pipe_Heat
        ...
        extends Lab_Units.Icons.Pipe;
        extends Lab_Units.Interfaces.PartialTwoPort_Heat;
        import Modelica.Math;
      ...
      equation
        ...
        heatport_a.T = Lab_Units.Functions.T_h(port_a.h_outflow);
      ...
      model Pipe_OC
        extends Lab_Units.Icons.Pipe_OC;
        extends Lab_Units.Interfaces.PartialTwoPort;
        ...
        parameter Real slope  "Pipe/channel slope S [%]";
        ...
        Real S_1 "Slope of the sewer normalised";
      ...
      equation
        ...
        WaterLevel = A_wet/((1/8)*(2*pi -sin(2*pi))*diameter^2)*100;
         ...
         //Manning's equation
         port_a.m_flow/rho = A_wet*(K_n/n)*(R_h)^(2/3)*(S_1)^(1/2);
      ...
      model Pipe_Junction
        ...
        extends Lab_Units.Icons.Pipe_Junction;
        extends Lab_Units.Interfaces.PartialTwoPort;
        import Modelica.Math;
        ...
        SI.Pressure dp "Differential pressure across the pipe";
        SI.VolumeFlowRate V_flow = port_a.m_flow/rho "volumetric flow";
        Real h_junction "Head loss ";
        SI.Velocity Vel = V_flow/(pi*diameter1^2/4) "Velocity of the fluid";
      ...
      equation
        ...
        h_junction = (k_fe+k_fc)*(Vel^2/(2*g));
...
*/
    ...
    extends Modelica.Icons.VariantsPackage;
      ...
      model Tank2inlet
        extends Lab_Units.Icons.Tank;
        import fcn = Lab_Units.Functions;
      ...
      equation
        ...
        port_a.p = Lab_Units.p_ambient;
        port_b.p = fluidLevel*g*rho + Lab_Units.p_ambient;
        ...
        port_a.h_outflow = fcn.h_T(Lab_Units.T_ambient);
      ...
      equation
        ...
        p0_tank = h0_tank*g*rho + Lab_Units.p_ambient;
        //Check for correct solution
        assert(fluidLevel <= fluidLevel_max, "Vessel is overflowing (fluidLevel > fluidLevel_max = " + String(fluidLevel) + ")");
       ...
       der(E) =port_a1.m_flow*actualStream(port_a1.h_outflow)+ port_a3.m_flow*actualStream(port_a3.h_outflow) - port_b.m_flow*
        ...
        port_a1.h_outflow = fcn.h_T(Lab_Units.T_ambient) "INCLUDE HEAT FLOW";
        port_a3.h_outflow = fcn.h_T(Lab_Units.T_ambient) "INCLUDE HEAT FLOW";
    ...
    extends Modelica.Icons.VariantsPackage;
      ...
      model Boiler
        extends Lab_Units.Icons.Boiler;
        extends Lab_Units.Interfaces.PartialTwoPort;
      ...
      model Radiator
        extends Lab_Units.Icons.Radiator;
        extends Lab_Units.Interfaces.PartialTwoPort;
    ...
    package Sensor
      model Temperature_Sensor
        ...
        SI.Temp_C T_meas;
      equation
        T_meas = SI.Conversions.to_degC(Lab_Units.Functions.T_h(port_b.h_outflow));
  ...
  package Units
    ...
    model PipeA
      extends Lab_Units.Icons.PipeBlock;
    ...
    model Pumping
      extends Lab_Units.Icons.PumpStation
      annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
            coordinateSystem(preserveAspectRatio=false)));
    ...
    model Consumer_Water
      extends Lab_Units.Icons.Consumer_Water;
    ...
    model Consumer_Heat
      extends Lab_Units.Icons.Consumer_Heat;
      extends Lab_Units.Interfaces.PartialTwoPort;
    ...
    model Heating
      extends Lab_Units.Icons.Heater
      annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
            coordinateSystem(preserveAspectRatio=false)));
  ...
  extends Modelica.Icons.ExamplesPackage;
    ...
    package Unit
      ...
      model Unit_PipeSewer
        ...
        VirtualWaterLab.Units.Sewer_Pipe pipeW(h_in2=0, h_in1=0)
      ...
      equation
        ...
        connect(pipeW.port_b2, sink_pT.port_a) annotation (Line(
            points={{20.2,50},{44,50},{44,46},{66,46}},
            color={0,0,0},
            thickness=0.5));
      end Unit_PipeSewer;
      ...
      model Sewer_LU
        ...
        extends Modelica.Icons.Example;
      //Parameters
      parameter Real LU_slope = 3 "Slope of the sewer coils in %";
      parameter Real LU_d = 0.05 "Sewer diameter in meters";

      parameter Real LU_qin1 = 1.8 "Inlet for the upper sewer in m3/h";
      parameter Real LU_qin2 = 1.8 "Inlet for the upper sewer in m3/h";



        Components.Pipes.Pipe_OC pipe_OC_upper(diameter= LU_d, slope= LU_slope)
          annotation (Placement(transformation(extent={{6,40},{26,60}})));
        Components.Pipes.Pipe_OC pipe_OC_lower(diameter= LU_d, slope= LU_slope)
          annotation (Placement(transformation(extent={{40,0},{60,20}})));
        Components.Pipes.Pipe pipe_upper(length=1, diameter=0.025)
          annotation (Placement(transformation(extent={{-44,40},{-24,60}})));
        Components.Pipes.Pipe pipe_lower(length=1, diameter=0.025)
          annotation (Placement(transformation(extent={{-44,0},{-24,20}})));
        Components.Sources.Sink_pT sink_pT
          annotation (Placement(transformation(extent={{80,0},{100,20}})));
        Components.Sources.Source_qT source_qT(m_flow=LU_qin1*1000/3600)
          annotation (Placement(transformation(extent={{-100,40},{-80,60}})));
        Components.Sources.Source_qT source_qT1(m_flow=LU_qin2*1000/3600)
          annotation (Placement(transformation(extent={{-100,0},{-80,20}})));
      equation
        connect(pipe_upper.port_b, pipe_OC_upper.port_a) annotation (Line(
            points={{-24,50},{6,50}},
            color={0,0,0},
            thickness=0.5));
        connect(pipe_lower.port_b, pipe_OC_lower.port_a) annotation (Line(
            points={{-24,10},{40,10}},
            color={0,0,0},
            thickness=0.5));
        connect(pipe_OC_lower.port_b, sink_pT.port_a) annotation (Line(
            points={{60,10},{80,10}},
            color={0,0,0},
            thickness=0.5));
        connect(pipe_OC_upper.port_b, pipe_OC_lower.port_a) annotation (Line(
            points={{26,50},{30,50},{30,10},{40,10}},
            color={0,0,0},
            thickness=0.5));
        connect(source_qT.port_b, pipe_upper.port_a) annotation (Line(
            points={{-80,50},{-44,50}},
            color={0,0,0},
            thickness=0.5));
        connect(source_qT1.port_b, pipe_lower.port_a) annotation (Line(
            points={{-80,10},{-44,10}},
            color={0,0,0},
            thickness=0.5));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
